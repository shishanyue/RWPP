package io.github.rwpp.desktop.impl.unit.custom.logicBooleans
    ...
    companion object{
        fun  addBooleanType(logicBoolean: LogicBoolean, logicBooleanDefinitions: Array<String>) {
            Reflect.callVoid<LogicBooleanInternal>(null,"addBooleanType",
                ...
                listOf(logicBoolean, logicBooleanDefinitions))

        }
        val booleans: HashMap<String, LogicBoolean>
            get() = Reflect.get<HashMap<String, LogicBoolean>>(LogicBooleanInternal::class,"booleans")!!
    }
