...
import io.github.rwpp.game.units.custom.logicBooleans.gameFunctions.IsBuildingBoolean

class IsBuildingBooleanImpl: IsBuildingBoolean, LogicGameFunctionBaseImpl() {
    override fun read(abstractUnitAgent: AbstractUnitAgent?): Boolean {
        return (abstractUnitAgent as AbstractUnitAgentImpl).isBuilding
    }
}